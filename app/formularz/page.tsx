...
/* ===== Pasek nawigacji (sticky) – wersja z hamburgerem dla mobile ===== */
  ...
  return (
    <header className="sticky top-0 z-50 header-blur">
      <div className="flex items-center justify-between py-3">
        ...
        <button aria-label="Menu" className="md:hidden inline-flex items-center justify-center rounded border border-gray-300 px-3 py-2" onClick={() => setOpen(v => !v)}>☰</button>
      </div>
      {open && (
...
/* SocialBar – jak na innych stronach */
function SocialBar() {
  const items = [
